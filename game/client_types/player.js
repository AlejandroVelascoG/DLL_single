...
stager.extendStep('training', {
    ...
    cb: function(){
      ...
      node.on.data('Settings', function(msg) {
        ...
        if (raza == 'terrier') {
          var texto = 'Observe que los perros de raza C tienen orejas un poco más puntiagudas, el pelaje siempre de color <font color=\'#882D17\'>siena natural</font> y un poco áspero, y suelen llevar la cola parada.';
        } else {
          var texto = 'Observe que los perros de raza B tienen el pelaje de un tono más claro y parduzco, y su contextura es más gruesa tanto de cuerpo como de hocico.';
        }
